...
public final class ContextUtils {
    ...
    public static Context getTopActivityOrApp() {
        if (isAppForeground()) {
            ...
            return topActivity == null ? ContextUtils.getApp() : topActivity;
        } else {
    ...
    public static boolean isAppForeground() {
        ActivityManager am = (ActivityManager) ContextUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am == null) {
            return false;
        }
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(ContextUtils.getApp().getPackageName());
            }
        }
        return false;
    }
    ...
    static class ActivityLifecycleImpl implements ActivityLifecycleCallbacks {
        ...
        private static void fixSoftInputLeaks(final Activity activity) {
            ...
            InputMethodManager imm =
                    (InputMethodManager) ContextUtils.getApp().getSystemService(Context.INPUT_METHOD_SERVICE);
            if (imm == null) {
                return;
            }
